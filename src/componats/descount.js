    ...
    <div class="descount d-flex flex-lg-row flex-column ">
      <div class="discount-desc position-relative p-3 p-lg-0  flex-grow-1 w-lg-50 w-100">
        <div class="top ps-5 position-relative">
          ...
          <span class="discount-subtitle ps-3">(marketing)</span>
        </div>
        ...
        <div class="bolletes text-center position-absolute  bottom-0 end-0 p-1 pe-3">
          <span className="d-inline-block  ms-3"></span>
          <span className="d-inline-block  ms-3"></span>
          <span className="d-inline-block  ms-3"></span>
        </div>
      </div>
      <div class="w-lg-50 w-100  d-flex  pt-lg-0 pt-3 ps-lg-3 h-100">
        <div class="discount-item w-50 me-3  position-relative overflow-hidden ">
          <img
            src="images/category-banner1.jpg"
            className="w-100 h-100 position-absolute top-0 start-0 "
            alt="dicount img"
          />
          <div class="discount-info position-absolute top-0 start-0 p-3">
            <h3>30% discount</h3>
            <h3>designing interior</h3>
          </div>
        </div>
        <div class="discount-item w-50   position-relative overflow-hidden ">
          <img
